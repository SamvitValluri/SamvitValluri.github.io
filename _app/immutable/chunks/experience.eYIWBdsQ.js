...
`,shortDescription:"Mechanical Engineering Team",links:[{}],logo:e.PSR,name:"Purdue Solar Racing",period:{from:new Date(2019,0,1),to:new Date(2020,11,1)},skills:t("Fusion360"),type:""},{slug:"PSP",color:"#ff3e00",description:`
## Objective
...
`,shortDescription:"Avionics Sub-Team",links:[{to:"https://purdueseds.space/wp-content/uploads/psp-sl/casper/cdr/Purdue%20University%20-%202020%20CDR%20Presentation.pdf",label:"Flight Readiness Review Presentation"},{to:"https://purdueseds.space/wp-content/uploads/psp-sl/casper/frr/Purdue%20University%20-%202020%20FRR%20Report.pdf",label:"Flight Readiness Review Report"}],logo:e.PSP,name:"Purdue Space Program",period:{from:new Date(2019,7,1),to:new Date(2020,11,1)},skills:t("Matlab","Solidworks"),type:""}],c={title:o,items:i};export{c as E};

import{A as e}from"./assets.BuFyeT-q.js";import{a as t}from"./skills.B25zKAHA.js";import{b as a}from"./paths.2eh1dZQn.js";const i="Projects",o=[{slug:"ME563",color:"#C28E0E",description:"",shortDescription:"",links:[{}],logo:e.Purdue,name:"Mechatronics Project",period:{from:new Date(2022,1,1),to:new Date(2022,4,1)},skills:t("cpp","Solidworks","Matlab"),type:""},{slug:"ME463",color:"#C28E0E",description:`
##Objective
...
<table>
  ...
  <tr>
    <td><img src="${a}/Project_Screenshots/AL2.gif"></td>
    <td><img src="${a}/Project_Screenshots/AL2.gif"></td>
    <td><img src="${a}/Project_Screenshots/AL2.gif"></td>
  </tr>
 </table>
...
`,shortDescription:"Avionics Sub-Team",links:[{to:"https://purdueseds.space/wp-content/uploads/psp-sl/casper/cdr/Purdue%20University%20-%202020%20CDR%20Presentation.pdf",label:"Flight Readiness Review Presentation"},{to:"https://purdueseds.space/wp-content/uploads/psp-sl/casper/frr/Purdue%20University%20-%202020%20FRR%20Report.pdf",label:"Flight Readiness Review Report"}],logo:e.PSP,name:"Purdue Space Program",period:{from:new Date(2019,7,1),to:new Date(2020,11,1)},skills:t("Matlab","Solidworks"),type:""}],l={title:i,items:o};export{l as E};

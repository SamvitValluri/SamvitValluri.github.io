import{A as e}from"./assets.DRXD5rDS.js";import{a as t}from"./skills.grOCnnu3.js";import{b as a}from"./paths.CNbgSzeF.js";const o="Projects",i=[{slug:"ME563",color:"#C28E0E",description:"",shortDescription:"",links:[{}],logo:e.Purdue,name:"Mechatronics Project",period:{from:new Date(2022,1,1),to:new Date(2022,4,1)},skills:t("cpp","Solidworks","Matlab"),type:""},{slug:"ME463",color:"#C28E0E",description:`
##Objective
`,shortDescription:"",links:[{}],logo:e.Purdue,name:"Senior Design Project",period:{from:new Date(2022,0,1),to:new Date(2022,4,1)},skills:t("cpp","Solidworks","ANSYS"),type:""},{slug:"heattransfer",color:"#C28E0E",description:`
...
![GIF1](${a}/Project_Screenshots/AL2.gif) ![GIF2](${a}/Project_Screenshots/CU2.gif) ![GIF3](${a}/Project_Screenshots/Steel2.gif)

`,shortDescription:"",links:[{to:"https://github.com/SamvitValluri/SamvitValluri--Nodal-Analysis-of-Flat-Plate",label:"Code"}],logo:e.Purdue,name:"Heat Transfer Analysis of Cookware",period:{from:new Date(2021,8,1),to:new Date(2021,10,1)},skills:t("py"),type:""},{slug:"solar",color:"#C28E0E",description:`
...
`,shortDescription:"Mechanical Engineering Team",links:[{}],logo:e.PSR,name:"Purdue Solar Racing",period:{from:new Date(2019,0,1),to:new Date(2020,11,1)},skills:t("Fusion360"),type:""},{slug:"PSP",color:"#C28E0E",description:`
## Objective
...
![CAD](${a}/Project_Screenshots/PSPCAD.png)

![Graph](${a}/Project_Screenshots/PSPGraph.png)

`,shortDescription:"Avionics Sub-Team",links:[{to:"https://purdueseds.space/wp-content/uploads/psp-sl/casper/cdr/Purdue%20University%20-%202020%20CDR%20Presentation.pdf",label:"Flight Readiness Review Presentation"},{to:"https://purdueseds.space/wp-content/uploads/psp-sl/casper/frr/Purdue%20University%20-%202020%20FRR%20Report.pdf",label:"Flight Readiness Review Report"}],logo:e.PSP,name:"Purdue Space Program",period:{from:new Date(2019,7,1),to:new Date(2020,11,1)},skills:t("Matlab","Solidworks"),type:""}],l={title:o,items:i};export{l as E};
